% simulate using MATLABs integrated LDPC decoder
function simulate_LDPC_integrated
...
% initiate MATLAB LDPC-Decoder
ldpcDec = comm.LDPCDecoder('ParityCheckMatrix', H, 'OutputValue','Whole codeword', 'MaximumIterationCount', iterations);
